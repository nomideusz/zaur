...
export async function fetchPageContent({ service, type, category, adType }) {
...
export function parseAdsOLX(html: string, propertyType: string, adType: string) {
...
export async function insertAds(ads, tableName) {
    for (const ad of ads) {
