<script>
	...
	const people = [
		...
		},
		{
			...
			quote:
				'I was shocked to see how effective such a nice animal could be. I would describe it as a mixture of horror and awe.',
			img: t4
		},
		{
		...
		<div class="md:grid md:grid-cols-2 md:items-center md:gap-10 lg:gap-16">
			<div class="mb-24 hidden sm:px-6 md:mb-0 md:block">
				<div class="relative">
					...
					<div class="absolute bottom-0 start-0 -z-[1] -translate-x-14 translate-y-10">
						<svg
							class="h-auto max-w-[10rem] text-slate-400 dark:text-slate-700"
							width="696"
							height="653"
							viewBox="0 0 696 653"
							fill="none"
			...
			<div>
				...
				<blockquote class="relative">
					<svg
						class="absolute start-0 top-0 h-24 w-24 -translate-x-8 -translate-y-4 transform text-gray-200 dark:text-gray-700"
						width="16"
						height="16"
						viewBox="0 0 16 16"
						fill="none"
					...
					<div class="relative z-10">
						<p
							class="mb-3 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-200"
						>
							Featured client
						</p>

						<p
							class="text-xl font-medium italic text-gray-800 dark:text-gray-200 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal"
						>
							{person.quote}
						</p>
					</div>
					...
					<footer class="mt-6">
						<div class="flex items-center">
							...
							<div class="ms-4 md:ms-0">
								...
								<div class="text-xs text-gray-500 dark:text-gray-400">{person.role}</div>
							</div>
						</div>
					</footer>
				</blockquote>
