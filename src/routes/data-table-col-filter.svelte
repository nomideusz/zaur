...
// Wartości filtru ceny
export let priceRange: { min: number | null; max: number | null } = { min: null, max: null };
  ...
  function updatePriceRange() {
    // Zakładając, że filterValues jest sklepem Svelte, aktualizuj priceRange
