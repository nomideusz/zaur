...
export const categoryCommentary: Record<string, string[]> = {
  'ai': [
...
export const zaurReactions: Record<string, string[]> = {
  'general': [
...
export const categorySpecificComments: Record<string, string[]> = {
  'dev': [
