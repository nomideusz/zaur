/**
 * MD5 hex digest (RFC 1321). Used for Gravatar email hashes.
 * Public-domain style implementation, browser-safe.
 */
...
/** Gravatar URL for an email address. Returns null when email is missing. */
export function gravatarUrl(email: string | undefined | null, size = 80): string | null {
