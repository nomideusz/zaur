...
function syncIdCookie(cookies: Cookies, id: string, options?: { remember?: boolean }): void {
	...
	// Share the session across sibling apps (e.g. webmail + Mail 2.0) by setting
	// the cookie on the parent domain — set SESSION_COOKIE_DOMAIN=.zaur.app in
	// production. Unset keeps the historic host-only cookie.
