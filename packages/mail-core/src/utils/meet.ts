/**
 * Calendar ↔ Meet helpers, shared by webmail and mail2. Meeting links are
 * stored in the event `location` field as a join URL (`/meet/{group}`) on
 * whichever app made them; either app joins the same LiveKit room from it.
 */
