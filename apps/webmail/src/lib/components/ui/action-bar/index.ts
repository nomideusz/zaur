/**
 * Svelte port of Shark UI `@shark/action-bar` (sharkui-inc/shark-ui registry).
 * API mirrors the React registry component; use with `example-table` composition for bulk select.
 */
