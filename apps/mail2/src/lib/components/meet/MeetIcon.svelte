<script lang="ts" module>
	...
	const PATHS = {
		...
		grid: 'M3.2 2h2.6a1.2 1.2 0 0 1 1.2 1.2v2.6a1.2 1.2 0 0 1-1.2 1.2H3.2A1.2 1.2 0 0 1 2 5.8V3.2A1.2 1.2 0 0 1 3.2 2zM10.2 2h2.6A1.2 1.2 0 0 1 14 3.2v2.6a1.2 1.2 0 0 1-1.2 1.2h-2.6A1.2 1.2 0 0 1 9 5.8V3.2A1.2 1.2 0 0 1 10.2 2zM3.2 9h2.6a1.2 1.2 0 0 1 1.2 1.2v2.6a1.2 1.2 0 0 1-1.2 1.2H3.2A1.2 1.2 0 0 1 2 12.8v-2.6A1.2 1.2 0 0 1 3.2 9zM10.2 9h2.6a1.2 1.2 0 0 1 1.2 1.2v2.6a1.2 1.2 0 0 1-1.2 1.2h-2.6A1.2 1.2 0 0 1 9 12.8v-2.6A1.2 1.2 0 0 1 10.2 9z',
		speaker: 'M3.2 2.2h9.6a1.4 1.4 0 0 1 1.4 1.4v5.4a1.4 1.4 0 0 1-1.4 1.4H3.2A1.4 1.4 0 0 1 1.8 9V3.6a1.4 1.4 0 0 1 1.4-1.4zM2.4 13.6h2.8M6.6 13.6h2.8M10.8 13.6h2.8',
		settings: 'M2 4.6h6.6M11.8 4.6H14M2 11.4h2.2M7.4 11.4H14M8.6 4.6a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0-3.2 0M4.2 11.4a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0-3.2 0',
		// Three dots, drawn as rings too small to have a hole.
		more: 'M3.1 8a.4.4 0 1 0 .8 0 .4.4 0 1 0-.8 0M7.6 8a.4.4 0 1 0 .8 0 .4.4 0 1 0-.8 0M12.1 8a.4.4 0 1 0 .8 0 .4.4 0 1 0-.8 0'
	} as const;
